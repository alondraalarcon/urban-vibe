                    ...
                    (
                        <div className="relative">
                            ...
                            {detail?.images.map((value:string, key:number) => (
                                <SwiperSlide key={key} className="!w-80 md:!w-full"><img src={value} className="object-fill rounded-xl md:h-screen h-80"/></SwiperSlide>
                            ))}
                            <div className="flex flex-row justify-between w-screen">
                                <div ref={navigationPrevRef} className="absolute left-4 top-1/2 z-50 text-white font-bold cursor-pointer hover:text-gray-900"><ChevronLeftIcon className="size-7"/></div>
                                <div ref={navigationNextRef} className="absolute right-4 top-1/2 z-50 text-white font-bold cursor-pointer hover:text-gray-900"><ChevronRightIcon className="size-7"/></div>
                            </div>
                            </Swiper>
                        </div>
                    )
                ...
                : (
                    <div className="flex flex-col gap-6 w-80 md:w-full">
                        ...
                        <div className="flex flex-row gap-8 items-center">
                            <button type="button" className="p-2 bg-gray-900 text-white w-64 h-12 rounded-lg hover:bg-gray-700">Add to Cart</button>
